@extends('adm.layouts.app', [
    'wsecond_title' => 'Province: Create',
    'sidebar_menu' => 'location',
    'sidebar_submenu' => 'province',
    'wheader' => [
        'header_title' => 'Province: Create',
        'header_breadcrumb' => [
            [
                'title' => 'Dashboard',
                'is_active' => false,
...
@section('content')
    <form action="{{ route('adm.province.store') }}" method="POST">
        @csrf

        <div class="card">
            <div class="card-header d-flex flex-lg-row flex-column align-items-center">
                <h3 class="card-title">Province: Add New</h3>
            ...
            <div class="card-body">
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="input-name" value="{{ old('name') }}" placeholder="Province Name">
